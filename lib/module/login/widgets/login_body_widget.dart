    ...
    return Padding(
      ...
      child: ListView(
        children: [
          ...
          Padding(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  Text('Email', style: customPoppin(fontSize: 14)),
                  LoginTextFeild(
                    validator: (email) {
                  ...
                  setHeight(height: 22),
                  Text('Password', style: customPoppin(fontSize: 14)),
                  Obx(
                    () => LoginTextFeild(
          ...
          InkWell(
            onTap: () {
              RoutesPaths.navigateToRoute(routeName: RoutesPaths.signUpView);
            },
            child: RichText(
              ...
              text: TextSpan(
                ...
                children: [
                  TextSpan(
                    text: ' Sign Up',
                    style: customMontserrat(fontSize: 16),
                  ),
                ],
              ),
            ),
