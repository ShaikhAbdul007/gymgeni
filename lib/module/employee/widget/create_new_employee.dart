...
class CreateNewEmployee extends StatelessWidget {
  ...
  const CreateNewEmployee({super.key, required this.controller});
      ...
      child: ListView(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Text('Create New Employee', style: customNunito(fontSize: 16)),
              InkWell(
                onTap: () {
                  Get.back();
                },
          ...
          Row(
            ...
            children: [
              NewEnquireComponent(
                ...
                label: 'Date of Birth',
                labelHintText: 'Select birth date',
                width: 200,
              ),
              NewEnquireComponent(
                readOnly: true,
                ...
                label: 'Joining Date',
                labelHintText: 'Select joining date',
                width: 200,
              ),
              NewEnquireComponent(
                readOnly: true,
              ...
              Obx(
                () =>
                    controller.isdataLoading.value
                        ...
                        : NewEnquireComponentWithDropDown(
                          hintText: 'Employee group',
                          error: 'Enter employee group',
                          isModelDropDownRequired: true,
                          width: 200,
