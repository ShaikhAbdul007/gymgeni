...
import 'package:gymgeni/module/signups/widget/gym_imageview_widget.dart';
...
class SignupTablet extends StatelessWidget {
  ...
  const SignupTablet({super.key, required this.controller});
                        ...
                        Obx(
                          () => Flexible(
                            child: SignupTextFeildWithLabel(
                              ...
                              tcontroller: controller.confrimpasswordController,
