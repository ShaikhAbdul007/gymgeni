class AddUpdateLeadCategoryModel {
  bool? status;
  String? message;
  AddLeadCategoryData? data;

  AddUpdateLeadCategoryModel({this.status, this.message, this.data});

  AddUpdateLeadCategoryModel.fromJson(Map<String, dynamic> json) {
    status = json['success'];
    message = json['msg'];
    data =
        json['data'] != null
            ? AddLeadCategoryData.fromJson(json['data'])
            : null;
  }
...
class AddLeadCategoryData {
  ...
  AddLeadCategoryData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    userId = json['user_id'];
