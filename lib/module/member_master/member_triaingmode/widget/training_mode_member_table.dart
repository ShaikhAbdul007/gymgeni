...
class TrainingModeMemberTable extends StatelessWidget {
  ...
  final List<MemberAllTrainingData> members;
  final void Function(MemberAllTrainingData member)? deleteOnTap;
  final void Function(MemberAllTrainingData member)? editOnTap;
